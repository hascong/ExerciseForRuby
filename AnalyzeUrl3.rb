...
File.open("/Users/congliu/Desktop/organic_analysis_2", 'w') { |fileOutput| 
...
filePath = "/Users/congliu/Downloads/tmp-1431061362-604800-554c4372620d9_copy_2.csv"
...
# 2746760 lines for organic 2015 01 02 03 04
...
yearMonthDetailed = Hash({"2015-01" => Hash.new, "2015-02" => Hash.new, "2015-03" => Hash.new, "2015-04" => Hash.new, "2015-05" => Hash.new}) 
...
while (line = fileInput.gets.chop and counterLine < maxLine)
    ...
    # 2746759 "2015-05-07 23:59:50","Coupang IOS",organic,,"Korea - South",35404,0,410
